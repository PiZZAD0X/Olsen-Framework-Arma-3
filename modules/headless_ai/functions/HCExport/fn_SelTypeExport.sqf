...
switch (_type2) do {
	case "objects": {
		...
		private _textObjects = switch _selectType do {
	...
	case "markers": {
		...
		private _textMarkers = switch _selectType do {
	...
	case "vehicles": {
		...
		private _textVehicles = switch _selectType do {
	...
	case "groups": {
		...
		private _textGroups = switch _selectType do {
